...
/*function squirrelsummon(){
    document.getElementById("squirrel").onmouseover="this.src='squirrels121.jpg'"onmouseout="this.src = 'squirrel121bw'"" =function() {squirrelsummon()};*/
    
  function squirrelsummon(){document.getElementById("squirrel").src="images\profiles\squirrels121.jpg";

  }  
  function oldquirrel(){document.getElementById("squirrel").src="images\profiles\squirrel121bw.jpg";
